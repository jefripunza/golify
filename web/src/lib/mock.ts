...
export const mockServers: Server[] = [
  {
    ...
    kubeEnabled: true,
    kubeRole: 'control-plane',
    kubeVersion: 'v1.33.0',
    kubeJoinCommand: 'kubeadm join 192.168.69.1:6443 --token ...',
    kubeCluster: 'golify',
    labels: '{"role":"control-plane","region":"home"}',
    notes: 'Mesin utama pengembangan.',
    createdAt: now(),
    updatedAt: now(),
  },
  {
    ...
    kubeRole: 'worker',
    kubeVersion: 'v1.33.0',
    kubeJoinCommand: 'kubeadm join 103.21.x.1:6443 --token ...',
    kubeCluster: 'golify',
    labels: '{"role":"worker","region":"jakarta"}',
    notes: 'VPS produksi.',
    createdAt: now(),
    updatedAt: now(),
  },
